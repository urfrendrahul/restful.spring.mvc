...
public class EmployeetController {
	...
	@RequestMapping(value = "/employee/{id}", method = GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Employee getEmployeeById(@PathVariable int id) {
        return employeeHandler.getEmployeeById(id);
    }

	
	@RequestMapping(value = "/employee", method = GET, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/employee/{id}", method = RequestMethod.DELETE,consumes=MediaType.APPLICATION_JSON_VALUE , produces = MediaType.APPLICATION_JSON_VALUE)
